...
describe('Match Schema Validation', () => {
  ...
  it('should reject cups_remaining above 10', () => {
    const invalidMatch = {
      id: '123e4567-e89b-12d3-a456-426614174001',
      date: '2026-01-27T10:00:00Z',
      teamA: ['123e4567-e89b-12d3-a456-426614174000'],
  ...
  it('should accept match with null cups_remaining and photo_url', () => {
    ...
    const result = matchSchema.safeParse(matchWithNulls);
    expect(result.success).toBe(true);
  });

  it('should reject cups_remaining when match is a tie (no clear winner)', () => {
    const tieWithCups = {
      id: '123e4567-e89b-12d3-a456-426614174001',
      date: '2026-01-27T10:00:00Z',
      teamA: ['123e4567-e89b-12d3-a456-426614174000'],
    ...
    const result = matchSchema.safeParse(tieWithCups);
    expect(result.success).toBe(false);
  });
