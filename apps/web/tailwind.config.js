...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        "gradient-cta": "linear-gradient(to right, #f59e0b, #eab308)", // amber-500 → yellow-500 (CTA, boutons d'action)
        "gradient-cta-alt": "linear-gradient(to right, #3b82f6, #7c3aed)", // [DEPRECATED] use gradient-cta for CTA, gradient-tab-active for nav
        "gradient-fab": "linear-gradient(to right, #f59e0b, #eab308)", // amber-500 → yellow-500 (aligné CTA, design-system 14-36)
        "gradient-tab-active": "linear-gradient(to right, #3b82f6, #7c3aed)", // blue-500 → violet-600 (tabs, navigation)
        "gradient-card":
