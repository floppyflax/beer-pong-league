/**
 * EloRecalcService — replays every ranked match attached to a league to
 * rebuild league_memberships ELO + elo_history.
 *
 * Triggered after admin edit/delete of a match (mig 021).
 *
 * Since mig 025, the replay logic lives server-side in the SECURITY DEFINER
 * function `recalculate_league_elo(p_league_id)`. This service is now a
 * thin RPC wrapper.
 */
