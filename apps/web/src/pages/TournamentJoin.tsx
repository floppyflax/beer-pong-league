            ...
            <>
                ...
                <div className="bg-gradient-card rounded-xl p-4 md:p-6 border border-slate-700/50">
                  ...
                  {selectedPlayerId && (
                    <button
                      ...
                      disabled={isJoining}
                      className="w-full bg-gradient-cta hover:opacity-95 text-white font-bold py-3 px-4 rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {isJoining
                        ? "Rejoindre..."
              ...
              <div className="bg-gradient-card rounded-xl p-4 md:p-6 border border-slate-700/50">
                ...
                <button
                  ...
                  className="w-full bg-gradient-cta hover:opacity-95 text-white font-bold py-3 px-4 rounded-xl transition-colors"
                >
                  Créer un nouveau joueur
                </button>
              </div>
              ...
              <form onSubmit={handleCreateNewPlayer} className="space-y-4">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    className="flex-1 bg-gradient-cta hover:opacity-95 text-white font-bold py-3 px-4 rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-lg min-h-[44px]"
                  >
