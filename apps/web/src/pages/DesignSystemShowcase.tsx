        ...
        <section className="space-y-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <GradientBar
                name="gradient-cta-alt (deprecated — use gradient-cta for CTA)"
            ...
            <p className="text-body-sm text-amber-400/90 mt-2 font-medium">
              Règle gradients (14-36) : CTA / FAB → gradient-cta (jaune-orange).
              Tabs / navigation → gradient-tab-active (bleu-violet).
            </p>
