...
export const Tournaments: React.FC = () => {
  ...
  if (loadError) {
    return (
      <ScreenLayout header={<ContextualHeader title="Mes Tournois" />}>
        <div className="space-y-4">
          <Banner message={loadError} variant="error" position="inline" />
          <div className="flex justify-center">
            <button
              onClick={() => reloadData()}
              className="bg-cup-red text-ink border-[1.5px] border-cup-red-deep shadow-[0_3px_0_#C42418] hover:brightness-110 active:translate-y-[2px] active:shadow-[0_1px_0_#C42418] font-archivo font-bold uppercase tracking-tight py-3 px-6 rounded-full transition-[transform,box-shadow,filter] duration-75"
            >
              Réessayer
            </button>
          </div>
          ...
          <div className="flex flex-col items-center justify-center text-center py-12 space-y-6 min-h-[40vh]">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button
                ...
                className="bg-paper text-ink border-[1.5px] border-card hover:border-card-muted font-archivo font-bold uppercase tracking-tight py-3 px-6 rounded-full transition-colors"
              >
      ...
      <div className="space-y-6">
        ...
        {filteredTournaments.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-ink-soft text-lg">Aucun résultat</p>
          </div>
        ) : (
