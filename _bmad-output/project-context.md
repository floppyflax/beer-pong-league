...
date: "2026-01-23"
sections_completed:
  ["technology_stack", "critical_rules", "patterns", "anti_patterns"]
---
...
- Barre CTA : `fixed bottom-16 inset-x-0 z-20 bg-slate-900 border-t border-slate-800 p-4 md:p-6`
- Bouton : `form="form-id"` pour associer au formulaire (bouton hors du `<form>`)

**Référence :** design-system-convergence.md section 5.3
