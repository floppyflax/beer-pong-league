...
describe('Leagues Page', () => {
  ...
  describe('Empty State', () => {
    it('should display empty state when no leagues', () => {
      ...
      expect(screen.getByText(/Créez votre première league/)).toBeInTheDocument();
    });
  ...
  describe('Create League Action', () => {
    ...
    it('should navigate to create-league when clicking create button', () => {
      ...
      // Create button: "CRÉER LEAGUE" in header (list view) or "Créer une league" (empty state)
      const createButton = screen.getByRole('button', { name: /créer.*league/i });
      fireEvent.click(createButton);
